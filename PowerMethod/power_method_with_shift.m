...
rel_err_cond = abs(condn_num/true_condn_num);

%fprintf(out_file, '%s, %i, %i, %f, %f, %f, %f, %f, %f \n', all_files(i).name, n, iter - 1, true_eig_val, lamda, abs_err, rel_err, condn_num, true_condn_num, rel_err_cond, symmetricity);
